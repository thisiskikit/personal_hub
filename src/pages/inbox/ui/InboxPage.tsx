...
export const InboxPage = () => {
  ...
  const applyBulk = (destination: Parameters<typeof processInboxItem>[1]) => {
  ...
  return (
    <>
      ...
      <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        {selectedIds.length ? (
          <div className="flex flex-wrap gap-1 border-b border-slate-100 bg-white px-4 py-2">
            <button
              type="button"
              onClick={() => applyBulk('event')}
