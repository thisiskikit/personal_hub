...
import type { AiModelOption, AssistantSaveMode, InboxParseResponse } from '@/shared/types/ai'
...
const AI_MODEL_STORAGE_KEY = 'aiModelOption'
...
export const AppShell = () => {
  ...
  const [aiModel, setAiModel] = useState<AiModelOption>(() =>
    readStorage<AiModelOption>(AI_MODEL_STORAGE_KEY, 'gpt-5.4'),
  )
  ...
  useEffect(() => {
    localStorage.setItem(AI_MODEL_STORAGE_KEY, JSON.stringify(aiModel))
  }, [aiModel])
